...
namespace MeetupAppNoCqrs.Domain
{
    public class Meetup
    {
        ...
        public Meetup(int id, int hostUserId, string name, int seatsAvailable)
        {
            Id = id;
        ...
        public Result ReserveSeat(int userId, DateTimeOffset when)
        {
        ...
        public Result CancelSeatReservation(int userId)
        {
    ...
    public class SeatReservation
    {
        ...
        public UserProfile ParticipantUser { get; private set; }
        public DateTimeOffset ReservationDate { get; private set; }

        internal SeatReservation(int participantUserId, DateTimeOffset reservationDate)
        {
