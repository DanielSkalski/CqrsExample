...
namespace MeetupAppCqrs.Infrastructure
{
    public class MeetupAppDbContext : DbContext
    {
        ...
        public DbSet<Meetup.ReadModel.MeetupDetails> MeetupDetailsReadModel { get; set; }
        public DbSet<Meetup.ReadModel.UserSeatReservations> UserSeatReservationsReadModel { get; set; }
